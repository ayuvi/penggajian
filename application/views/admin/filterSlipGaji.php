    ...
    <div class="card mx-auto" style="width: 35%">
        ...
        <form action="<?= base_url('admin/SlipGaji/cetakSlipGaji') ?>" method="POST">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label for="inputTahun" class="col-sm-3 col-form-label">Nama Pegawai</label>
                    <div class="col-sm-9">
                ...
                <button style="width: 100%" type="submit" class="btn btn-primary"><i class="fas fa-print"></i>Cetak Slip Absensi</button>
            </div>
    </div>
    </form>
</div>